...
declare -a model_paths=( \
                        '/mnt/petrelfs/renyiming/model/LLaVA16/llava_34b' \
                        # '/mnt/petrelfs/renyiming/model/LLaVA1/llava_1.5' \
                        # '/mnt/petrelfs/renyiming/model/LLaVA16/llava_1.6' \
                        # '/mnt/petrelfs/renyiming/model/LLaVA1/llava_vila13b' \
                        )

declare -a sample_files=('/mnt/petrelfs/share_data/renyiming/llavastyle/it.jsonl' \
                        '/mnt/petrelfs/share_data/renyiming/llavastyle/ii.jsonl' \
                        '/mnt/petrelfs/share_data/renyiming/llavastyle/ct.jsonl' \
                        '/mnt/petrelfs/share_data/renyiming/llavastylei.jsonl')

# declare -a sample_files=('/mnt/petrelfs/share_data/duanyuchen/mm_niah/niah/infer-choose.jsonl' \
