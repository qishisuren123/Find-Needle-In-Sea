...
# declare -a sample_files=('/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/ragged_ci.jsonl' \
#                          '/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/ragged_ct.jsonl' \
#                          '/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/ragged_ii.jsonl' \
#                          '/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/ragged_it.jsonl' \
#                          )

declare -a sample_files=('/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/ragged__infer-choose.jsonl' \
...
# declare -a sample_files=('/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/ii.jsonl' )
...
for ((i=0; i<${#model_paths[@]}; i++)); do
    for ((j=0; j<${#sample_files[@]}; j++)); do
        ...
        srun -p INTERN3 \
            --gres=gpu:1 \
            --quotatype=spot \
            python /mnt/petrelfs/renyiming/dataset/sea-needle/eval/eval_llava_infer_tem.py \
