...
declare -a sample_files=('/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/rag_infer-choose.jsonl' \
                         '/mnt/petrelfs/renyiming/LTT/NeedleInSea/llava_style_new/llavastyle/rag_visual-reasoning.jsonl' \
                         )
