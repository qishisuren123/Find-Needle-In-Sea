...
from dataset_interleaved_ import InterleavedDataset, TCSLoader
from dataset_interleaved_ import (
...
filepath = '/mnt/petrelfs/liushuo/VQAG/obelisc_10m.json'
...
def gradio_app_vis_incontext_trainset(_filepath):
    ...
    long_save_path = str("/mnt/lustre/liushuo/VQAG/long_document")
    ...
    app.launch(share=True, server_name="0.0.0.0", server_port=server_port)
